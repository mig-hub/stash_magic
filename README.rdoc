...
- Specs for Sequel ORM but pretty seamless to adapt
- Easy to understand (one file) module 

This is still in Beta version.
Documentation is comming soon.
In the meantime, you can have a look at the specs to see how it's used or contact me on github if you have any question: http://github.com/mig-hub
