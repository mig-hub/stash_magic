...
module PainlessBackend
  # A replacement for ::PainlessBackend::Attachmentable
  # New requirements being:
  # - More than one attachment per model
  # - Easiest way to deal with folders (a bit like on the_wall)
  # - Another way to deal with convert styles so that you can interract with it (cropping for example)
